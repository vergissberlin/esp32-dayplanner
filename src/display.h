...
void setupDisplay(appointments)
{
    ...
    display.println(appointments["previous"]["time"].as<String>());
    display.setCursor(startXcol2, startY + lineHeight * 0);
    display.println(appointments["previous"]["title"].as<String>());

    // Current
    display.setFont(&FreeSansBold9pt7b);
    display.setCursor(startXcol1, startY + lineHeight * 1);
    display.println(appointments["current"]["time"].as<String>());
    display.setCursor(startXcol2, startY + lineHeight * 1);
    display.println(appointments["current"]["title"].as<String>());

    // Next
    display.setFont(&FreeSans9pt7b);
    display.setCursor(startXcol1, startY + lineHeight * 2);
    display.println(appointments["next"]["time"].as<String>());
    display.setCursor(startXcol2, startY + lineHeight * 2);
    display.println(appointments["next"]["title"].as<String>());
